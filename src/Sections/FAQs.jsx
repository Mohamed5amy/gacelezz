...
const FAQ = ({q , a}) => {
    ...
    return (
        <Stack mb={active ? 2 : 8} height={active === 1 ? "250px" : "89.6px"} border={!active && "1px solid #453838"} borderRadius={"16px"} bgcolor={"#180203"} sx={{transition : ".5s" , "&:hover" : {cursor : "pointer"}}} onClick={() => active === 0 ? setActive(1) : setActive(0)} overflow={"hidden"}>
